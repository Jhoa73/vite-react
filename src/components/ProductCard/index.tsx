	...
	return (
		<div className={"bg-white cursor-pointer w-56 h-60"} onClick={onclick}>
			<figure className={"relative mb-2 w-full h-4/5"}>
				<span
					className="absolute bottom-0 left-0 bg-white/60 rounded-lg text-black text-xs m-2 px-3 py-0.5">{tag}</span>
				<img src={linkImg} alt="name" className="w-full h-full object-fill rounded-lg"/>
				<span
